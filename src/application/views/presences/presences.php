<div class="row">
	<div class="col-md-12">
			<button type="button" class="btn btn-success">Data Kehadiran <span class="badge">></span></button> 
		<hr/>
	</div>
</div>
<div class="row">
    ...
    ?>
    <!--<option>Akhmad Fikri Hassan</option>-->
    <!--<option>Antonius Marianus Ceme Nuwa</option>-->
    <!--<option>Ari Rachmawati</option>-->
    <!--<option>Arum Titisari</option>-->
    <!--<option>Bayu Sapta Hari</option>-->
    <!--<option>Devi Anjarsari</option>-->
    <!--<option>Didit Sukmana</option>-->
    <!--<option>Denda Sutanto</option>-->
    <!--<option>Dimas Yuri Ramdhana</option>-->
    <!--<option>Friska Indah Kartika</option>-->
    <!--<option>Hetti Murdiasih</option>-->
    <!--<option>Ida Syafrida</option>-->
    <!--<option>Irman</option>-->
    <!--<option>Iqbal Eikman</option>-->
    <!--<option>Joko Sutrisno</option>-->
    <!--<option>Kusuma Parahita </option>-->
    <!--<option>Minarni Try Astuti</option>-->
    <!--<option>Nur Santi</option>-->
    <!--<option>Ratno Riyadi</option>-->
    <!--<option>Reinhart Rollando</option>-->
    <!--<option>Rifai Al-Ghifari</option>-->
    <!--<option>Rohmat</option>-->
    <!--<option>Sri Purnayenti</option>-->
    <!--<option>Tutik Ariyanti </option>-->
    <!--<option>Tri Cahyani</option>-->
    <!--<option>Tri Yuswanto</option>-->
    <!--<option>Yeni Sarah</option>-->
